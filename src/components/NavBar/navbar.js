    ...
    return (
        <nav className="navbar">
            ...
            <div className="desktopMenu">
                ...
                <Link activeClass='active' to='internships' spy={true} smooth={true} offset={-50} duration={500} className="desktopMenuListItem">Internships</Link>
            ...
            <button className="desktopMenuBtn" onClick={()=>{ document.getElementById("contact").scrollIntoView({ behavior:"smooth"}); }}><FaPaperPlane />
                Contact Me
            </button>
            ...
            <div className="navMenu" style={{display: showMenu? 'flex':'none'}}>
                ...
                <Link activeClass='active' to='internships' spy={true} smooth={true} offset={-50} duration={500} className="listItem" onClick={()=>setShowMenu(false)}>Internships</Link>
